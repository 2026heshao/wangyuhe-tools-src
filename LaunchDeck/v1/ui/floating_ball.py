...
from PyQt6.QtWidgets import (
    QWidget, QApplication, QMenu, QGraphicsDropShadowEffect, QInputDialog,
)

from core.app_manager import (
    AppManager, launch_app, make_app_from_path, resolve_lnk_target,
    render_app_icon, clear_icon_cache, _launch_elevated,
)
