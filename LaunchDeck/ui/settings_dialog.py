...
from core.app_manager import (
    AppManager, get_exe_name, extract_app_icon, clear_icon_cache,
...
class _ListRow(QWidget):
    ...
    def __init__(self, app: dict, parent=None):
        ...
        icon_label.setPixmap(extract_app_icon(app.get("exe_path", ""), 17,
                                              app.get("name", "")))
...
class AddAppDialog(_FramelessShell):
    ...
    def _on_path_changed(self, text: str):
        ...
        self._preview_t2.setText(os.path.basename(path))
    ...
    def _on_confirm(self):
        ...
        self.result_app = {"name": name, "exe_path": path}
        self.accept()
